...
class TDTestCase:
    ...
    def run(self):
        ...
        tdLog.info('create table tb (ts timestamp, a0123456789012345678901234567890123456789 int)')
        tdSql.execute('create table tb (ts timestamp, a0123456789012345678901234567890123456789 int)')
        #TSIM: sql drop table $tb
        tdLog.info('drop table tb')
        tdSql.execute('drop table tb')
        #TSIM: 
